...
import (
	...
	"github.com/dwprz/prasorganic-product-service/src/core/restful/router"
...
type Restful struct {
	app                   *fiber.App
	productRestfulHandler *handler.Product
	middleware            *middleware.Middleware
}

func New(prh *handler.Product, m *middleware.Middleware) *Restful {
